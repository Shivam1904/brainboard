...
class AlarmService:
    ...
    async def get_alarm_details_and_activity(self, widget_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            stmt = select(AlarmItemActivity).where(
                ...
                AlarmItemActivity.created_at >= date.today()
            )
            result = await self.db.execute(stmt)
            today_activity = result.scalars().first()
            ...
            if not today_activity:
                ...
                await self.db.refresh(today_activity)
    ...
    async def snooze_alarm(self, activity_id: str, snooze_minutes: int = 2) -> Optional[Dict[str, Any]]:
    ...
    async def stop_alarm(self, activity_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def create_alarm_activity_for_today(self, widget_id: str, user_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def create_alarm_details(self, widget_id: str, title: str, alarm_times: list = None, user_id: str = None) -> Dict[str, Any]:
    ...
    async def get_alarm_details(self, widget_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def update_or_create_alarm_details(self, widget_id: str, title: str, alarm_times: list = None, user_id: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if alarm_details:
                ...
                return await self.create_alarm_details(
                    widget_id=widget_id,
                    title=title,
                    alarm_times=alarm_times,
                    user_id=user_id
    ...
    async def update_alarm_details(self, alarm_details_id: str, update_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
