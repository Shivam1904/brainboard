"""
WebSearch summary AI output model for AI-generated web search summaries.
"""
...
# MODEL
# ============================================================================
class WebSearchSummaryAIOutput(BaseModel):
    ...
    ai_model_used = Column(String, nullable=True)  # 'gpt-4', 'gpt-3.5-turbo', 'fallback'
